...
const { setQueues } = createBullBoard({
	...
	options: {
		uiConfig: {
			...
			dateFormats: {
				...(config.BULL_BOARD_DATE_FORMATS_SHORT && {
					short: config.BULL_BOARD_DATE_FORMATS_SHORT,
				}),
				...(config.BULL_BOARD_DATE_FORMATS_COMMON && {
					common: config.BULL_BOARD_DATE_FORMATS_COMMON,
				}),
				...(config.BULL_BOARD_DATE_FORMATS_FULL && {
					full: config.BULL_BOARD_DATE_FORMATS_FULL,
				}),
			},
		},
	},
