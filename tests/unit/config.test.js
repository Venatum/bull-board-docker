...
describe('Configuration', () => {
  ...
  describe('Redis Configuration', () => {
    ...
    it('should handle additional Redis configuration options', () => {
      // Set environment variables
  ...
  describe('Sentinel Configuration', () => {
    it('should load Sentinel configuration from environment variables', () => {
      // Set environment variables
    ...
    it('should use default values for Sentinel configuration when not set', () => {
      // Import the module to test
      const { config } = getConfig();
  ...
  describe('Queue Configuration', () => {
    it('should load Queue configuration from environment variables', () => {
      // Set environment variables
  ...
  describe('App Configuration', () => {
    ...
    it('should load Bullboard UI configuration from environment variables', () => {
      // Set environment variables
  ...
  describe('Path Handling', () => {
    it('should normalize paths correctly', () => {
      ...
      // Import the module to test
      const { config, PROXY_PATH } = getConfig();
